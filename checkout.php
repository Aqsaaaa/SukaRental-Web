	...
	<div class="logo_products">
		<div class="container">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">SukaRental</a></h1>
			</div>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="nearby.php">Search Loc</a></li>
									<li><a href="cart.php">Keranjang Saya</a></li>
									<li><a href="daftarorder.php">Daftar Order</a></li>
									<li><a href="pricerange.php">Price Range</a></li>
								</ul>
							</div>
							</nav>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> motor di Sukarental</span></h1>
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					...
					<ul>
						...
						$conn -> query("UPDATE produk SET stok = 'stok -1'
			...
			<hr>
			<br><center>
			<h2>Total harga yang tertera di atas sudah termasuk biaya administrasi Rp10.000</h2>
		...
		<br>
        <br>
        <p>Orderan anda Akan Segera kami proses 1x5 Jam Setelah Anda Melakukan Pembayaran ke ATM kami dan menyertakan informasi pribadi yang melakukan pembayaran seperti Nama Pemilik Rekening / Sumber Dana, Tanggal Pembayaran, Metode Pembayaran dan Jumlah Bayar.</p>
