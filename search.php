...
<html>
<head>
<title>SukaRental - Pencarian</title>
	...
	<div class="products">
		<div class="container">
			...
			<div class="col-md-8 products-right">
				...
				<?php 
					$brgs=mysqli_query($conn,"SELECT * from produk where hargaafter like '%$s%' order by idproduk ASC");
									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												...
												<h4>Rp<?php echo number_format($p['hargaafter']) ?> </span></h4>
											</div>
