		...
		{	
			header('location:login.php');
				...
				if($liat>0){
							...
							$brpbanyak = mysqli_fetch_assoc($cekbrg);
							$jmlh = $brpbanyak['qty'];
...
<html>
<head>
<title>SukaRental - Produk</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="SukaRental, Richard's Lab" />
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="cart.php">Orderan Saya</a></li>
	...
	<div class="products">
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_center" style >
				...
				<h2><?php echo $p['namaproduk'] ?></h2>
					...
					<div class="w3agile_description">
						...
						<a src="https://maps.google.com/maps?q=<?php echo $p['deskripsi'] ?>&output=embed"></a><iframe width="50%%" height="250" src="https://maps.google.com/maps?q=<?php echo $p['deskripsi'] ?>&output=embed"></iframe>

						
					</div>
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4 class="m-sing">Sewa (Hari) :</h4>
						...
						<div class="snipcart-details agileinfo_single_right_details">
							<form action="#" method="post">
								<fieldset>
									...
									<input type="submit" name="addprod" value="Add to Order" class="button">
								</fieldset>
							</form>
						</div>
					</div>
